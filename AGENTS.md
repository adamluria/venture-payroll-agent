...
- Flagged agents highlighted in coral, approved items in teal, pending reviews in amber
...
- Test Docker builds locally before deploying: `docker build -t venture-payroll-agent . && docker run -p 8080:8080 venture-payroll-agent`
...
claude --add-dir .
# Paste: "You are the Frontend Agent for venture-payroll-agent. [Track B brief here]"

# Terminal 2 — start data-integration agent
claude --add-dir .
# Paste: "You are the Data Integration Agent for venture-payroll-agent. [Track A brief here]"
```
